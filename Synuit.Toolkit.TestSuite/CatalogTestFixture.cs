...
namespace Synuit.Toolkit.Tests
{
    ...
    {
      private const string PathA = "Synuit.Toolkit.Test.Plugin.A.dll";
      private const string PathB = "Synuit.Toolkit.Test.Plugin.B.dll";
      ...
      {
         var repo = Path.GetDirectoryName(typeof(CatalogTestFixture).Assembly.Location);
