...
using Precept.Architecture.Types.App;
...
namespace Precept.Metadata
{
   ...
   //
   public class Workspace<C, I> : Types.IWorkspace<C, I> where C : Metadata.Context where I : Metadata.Item
   {
      public C Context { get; set; }

      Types.IContext IWorkspace<C, I>.Context
      {
