	...
	public class ResourceForm : MetroFramework.Forms.MetroForm
	{
		...
		protected override void OnLoad(EventArgs e)
		{
         //$!!$
			...
			////////$!!$string text = BossMain.StringResources.GetString(formname, System.Threading.Thread.CurrentThread.CurrentCulture);
			//////if (text != null)
			//////{
			//////	this.Text = text;
			//////}
			...
			//////	text = BossMain.StringResources.GetString(controlname, System.Threading.Thread.CurrentThread.CurrentCulture);
			//////	if (text != null)
			//////	{
