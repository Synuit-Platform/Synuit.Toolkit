...
namespace Synuit.Metadata.Editor
{
	...
	/// </summary>
	public partial class DiagnosticForm : Synuit.Metadata.Editor.ResourceForm
	{
      //$!!$
		/////////// <summary>
		...
		private void ErrorReportForm_Load(object sender, EventArgs e)
		{
         //$!!$
			...
			//////////////////try
			//////////////////{
			//////////////////	dataText.Text = BossHelper.PGPEncrypt(BuildDiagnostics(), BossHelper.BOSS_PGP_PUBLICKEY);
			//////////////////}
			//////////////////catch (Exception ex)
			//////////////////{
		...
		private string BuildDiagnostics()
		{
         ...
         //////////////	BossConfig clone = this.Config.Clone() as BossConfig;
         ...
         //////////////	diag.Append(BossHelper.ReadBackupFromRegistry(this.Config)).Append(Environment.NewLine).Append(Environment.NewLine);
         //////////////}
