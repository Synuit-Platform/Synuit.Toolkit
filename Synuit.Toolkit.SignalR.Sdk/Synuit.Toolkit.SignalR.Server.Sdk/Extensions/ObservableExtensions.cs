...
namespace Synuit.Toolkit.SignalR.Server.Extensions
{
    public static class ObservableExtensions
    {
      ...
      //
      //public async static IAsyncEnumerable<T> AsAsyncStream<T>(this IObservable<T> observable, int? maxBufferSize = null)
      //{
      //   // This sample shows adapting an observable to a ChannelReader without 
      //   // back pressure, if the connection is slower than the producer, memory will
      //   // start to increase.
